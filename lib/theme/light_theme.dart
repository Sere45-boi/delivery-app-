...
ThemeData light = ThemeData(
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF00A8A8))),
  colorScheme: const ColorScheme.light(primary: Color(0xFF00A8A8), secondary: Color(0xFF00A8A8)).copyWith(error: const Color(0xFFE84D4F)),
